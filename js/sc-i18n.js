...
const AR = {
  ...
  'Extra': 'إضافية',
  'Video': 'فيديو',
  'Inside or lining': 'من الداخل أو البطانة',
  'Corners and edges': 'الزوايا والحواف',
  'Any flaws, up close': 'أي عيوب، عن قرب',
  'Worn or styled': 'أثناء الارتداء أو التنسيق',
  'Box or receipt': 'العلبة أو الفاتورة',
  'Anything else': 'أي شيء آخر',
  'A slow pan in good light, optional': 'لقطة بطيئة بإضاءة جيدة، اختياري',
  'Not in the list? Just type the brand name.': 'الماركة غير موجودة في القائمة؟ اكتب اسمها فقط.',
  ...
  'Open': 'فتح',
  'Unlist': 'إلغاء العرض',
  'Edit listing': 'تعديل القطعة',
  'Approve as seller': 'اعتماد كبائع',
  ...
  'Cash on handover': 'الدفع عند الاستلام',
  'Pay in person when you meet': 'ادفع شخصياً عند اللقاء',
  'optional': 'اختياري',
